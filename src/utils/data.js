...
export const tbrDecks = {
    ...
    "Genre Roulette": {
        ...
        "prompts": [
            ...
            'A fairytale or a modern retelling of one',
            'A graphic novel',
            'A mystery novel',
            'A thriller',
            'A political drama, fiction or non-fiction',
            'A satirical novel',
            ...
            'A romance',
            'A horror',
            'Something considered chick lit',
            'An alternate history',
            'A book with an action & adventure plot',
            'A book that has footnotes',
            'A non-fiction book focused on the history of a city',
            'A book about LGBTQ+ history',
            'A book written by a comedian',
            'A book from a genre you rarely choose',
            'A book about women\'s history or gender studies',
            'A book about anit-racism',
            'A book about civil rights history',
            'The first book in a series',
            'A book by an author who writes in more than one genre',
            'A book about how the body - or some part of it - works',
            'A book you are embarrased you want to read',
            'A book from a genre you are intimidated by or find challenging',
            'A contemporary fiction',
            'A classic',
            'A book considered literary fiction',
            'A novel that\'s been nominated for a prize',
            'A non-fiction that\'s been nominated for a prize',
            'A book about the subject you chose to study (or would want to study) in school',
            'Wild Card',
            'Wild Card',
            'Wild Card',
            'Wild Card',
            'Wild Card',
            'A comic book',
            'A book that has been turned into a movie or TV show',
            'A play',
            'A book with an ureliable narrator',
            'A book with an unlikeable protagonist',
            ...
            'A book you really want to love which makes you nervous to read it',
            'A book recommended to you by a friend',
            'Your best friend\'s favorite book or a book by their favorite author',
            'A book loved by one of your family members',
